...
- Modify, edit, alter, or change the VoidUI source code.
- Fork, clone, or create a derivative version of VoidUI.
- Redistribute, republish, mirror, re-upload, or share VoidUI or its source code.
- Sell, sublicense, license, or distribute VoidUI or any portion of it.
- Claim VoidUI or any part of its source code as your own.
- Remove or alter copyright or license notices.
- Deobfuscate, decrypt, unpack, or attempt to recover protected or intentionally obscured source code.
- Reverse engineer, disassemble, or attempt to derive the source code or implementation.
- Leak, publish, upload, or otherwise make the VoidUI source code available to third parties.
- Use VoidUI as the basis for another library, framework, or derivative project.
- Repackage or redistribute VoidUI under another name.
- Copy any portion of the VoidUI source code into another project.
- Circumvent any technical protection or access restriction used by VoidUI.
...
No other rights are granted, whether express, implied, or otherwise.
